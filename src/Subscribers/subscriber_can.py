...
from src.State.robot1_level0.canstmach import nmt_bus, nmt_machine
from src.State.robot1_level0.drivest import dvst_machine, dvst_bus
from src.State.robot1_level0.drivemd import dvmd_machine, dvmd_bus
from src.State.robot1_level0.sp import speed_and_pos, speed_and_pos_bus
from src.State.robot1_level0.homing_valid import homing_machine, homing_bus
from src.Monitors.monitor import never



point_connexion = broker.Endpoint()
subscriber = point_connexion.make_subscriber("/robot1/can")
